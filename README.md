...
1. Overlord cards are unique cards representing powerful opponents that can be added to the game. They have
   the ![img.png](icons/challenge-action.png) icon.
...
1. Reward tokens represent successful interactions with the Overlord. They have the ![img.png](icons/reward-token.png) icon.
...
1. Most Overlord cards define at least one challenge action. Challenge actions have ![img.png](icons/challenge-action.png) in their
   cost.
...
1. Rest actions and challenge actions also follow this format but are not considered minor actions. They have
   either ![img.png](icons/rest-action.png) or ![img.png](icons/challenge-action.png) in their cost.
...
1. Set the player’s attack power to the sum of all visible ![img.png](icons/attack-up.png) icons, reduced by the sum of all
   visible ![img.png](icons/attack-down.png) icons. If the value is less than zero, the value is zero.
1. Set the player’s defense power to the sum of all visible ![img.png](icons/defense-up.png) icons, reduced by the sum of all
...
1. Increase the attack power of the owner by the sum of the ![img.png](icons/attack-up.png) icons on the activated parts and
   the ![img.png](icons/attack-down.png) icons on the deactivated parts. Decrease the attack power of the owner by the sum of
   the ![img.png](icons/attack-down.png) icons on the activated parts and the ![img.png](icons/attack-up.png) icons on the
   deactivated parts. If the resulting value is less than zero, it becomes zero.
1. Increase the defense power of the owner by the sum of the ![img.png](icons/defense-up.png) icons on the activated parts and
   the ![img.png](icons/defense-down.png) icons on the deactivated parts. Decrease the defense power of the owner by the sum of
   the ![img.png](icons/defense-down.png) icons on the activated parts and the ![img.png](icons/defense-up.png) icons on the
   deactivated parts. If the resulting value is less than zero, it becomes zero.
...
| ![img.png](icons/challenge-action.png)                                                                     | This is not a minor action, but a challenge action.                                     |
...
| When ![img.png](icons/challenge-action.png)                                                        | Whenever you are resolving a challenge action.                                                                   |
| If there is 1![img.png](icons/reward-token.png) per player on the ![img.png](icons/village.png)    | Whenever there is a number of reward tokens on the village card equal to the number of players.                  |
| If there are 3 or more ![img.png](icons/reward-token.png) per player on the Overlord.              | Whenever there is a number of reward tokens on the Overlord card equal to three times the number of players.     |
...
| TextMeaning                                                                                                                                                                                                                                                                                                                                                                                                |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| You can’t be the target of card abilities during other player’s turnsDuring the turn of another player, when resolving card abilities:                                                                                                                                                                                                                                                                     |
| •You can’t be selected as a target player or another player.                                                                                                                                                                                                                                                                                                                                               |
| •Effects that affect “other players” or “each player” don’t affect you.                                                                                                                                                                                                                                                                                                                                    |
| You can be affected during an Overlord’s turn.                                                                                                                                                                                                                                                                                                                                                             |
| Take 1![img.png](icons/TODO) or lose 2![img.png](icons/TODO)You make take one damage. If you don’t, discard two crystals.                                                                                                                                                                                                                                                                                  |
| Take 1![img.png](icons/TODO) for each ![img.png](icons/TODO) you haveTake damage equal to your wound count.                                                                                                                                                                                                                                                                                                |
| Take 1![img.png](icons/TODO) for each ![img.png](icons/TODO)Take damage equal to your item count.                                                                                                                                                                                                                                                                                                          |
| Take 1![img.png](icons/TODO) from another playerChoose another player with a wound count of one or more. He heals one damage, and you take one damage.                                                                                                                                                                                                                                                     |
| Give 1 of your ![img.png](icons/TODO) to another playerIf you have a wound count of one or more, heal one damage and another player takes one damage.                                                                                                                                                                                                                                                      |
| Transfer 1![img.png](icons/TODO) to ![img.png](icons/TODO)If you have a wound count of one or more, heal one damage and the Overlord takes one damage.                                                                                                                                                                                                                                                     |
| Give 4 of your ![img.png](icons/TODO) to other playersIf you have a wound count of one or more, heal one damage and another player takes one damage. Repeat this four times. You may choose the same player multiple times. The other players take the assigned damage in one effect.                                                                                                                      |
| Deal 1![img.png](icons/TODO) to another playerAnother player takes one damage.                                                                                                                                                                                                                                                                                                                             |
| Deal N![img.png](icons/TODO) to other players                                                                                                                                                                                                                                                                                                                                                              |
| ⮴ Other players take N![img.png](icons/TODO)Each other player takes N damage.                                                                                                                                                                                                                                                                                                                              |
| Deal 1![img.png](icons/TODO) to other players for every 2![img.png](icons/TODO)Each other player takes damage equal to your attack power divided by two, rounded down.                                                                                                                                                                                                                                     |
| All players take N![img.png](icons/TODO)Each player takes N damage.                                                                                                                                                                                                                                                                                                                                        |
| All players take 2![img.png](icons/TODO) or lose 3![img.png](icons/TODO)Each player may take two damage. If they don’t, they discard three crystals.                                                                                                                                                                                                                                                       |
| Players take 1![img.png](icons/TODO) for each ![img.png](icons/TODO) on Journey Track cardsEach players takes damage equal to the number of wound tokens on the journey track cards.                                                                                                                                                                                                                       |
| Other players take 1![img.png](icons/TODO) for each of their ![img.png](icons/TODO)Each other player takes damage equal to their speed value.                                                                                                                                                                                                                                                              |
| Heal N![img.png](icons/TODO)Heal N damage.                                                                                                                                                                                                                                                                                                                                                                 |
| Heal D6![img.png](icons/TODO)Roll a six-sided die, heal damage equal to the die value.                                                                                                                                                                                                                                                                                                                     |
| Heal all your ![img.png](icons/TODO)Heal all your damage.                                                                                                                                                                                                                                                                                                                                                  |
| Player to your left heals 2![img.png](icons/TODO)The player to your left heals two damage.                                                                                                                                                                                                                                                                                                                 |
| Player to your right heals 2![img.png](icons/TODO)The player to your right heals two damage.                                                                                                                                                                                                                                                                                                               |
| Player with the most ![img.png](icons/TODO) heals 4![img.png](icons/TODO)Choose one of the players with the highest wound count. That player heals four damage.                                                                                                                                                                                                                                            |
| Other players heal N![img.png](icons/TODO)Each other player heals N damage.                                                                                                                                                                                                                                                                                                                                |
| All players heal 2![img.png](icons/TODO)Each player heals two damage.                                                                                                                                                                                                                                                                                                                                      |
| Your ![img.png](icons/TODO) cannot be healedAll effects that would heal you do nothing.                                                                                                                                                                                                                                                                                                                    |
| N![img.png](icons/TODO)Increase your attack power by N.                                                                                                                                                                                                                                                                                                                                                    |
| ![img.png](icons/TODO)![img.png](icons/TODO)                                                                                                                                                                                                                                                                                                                                                               |
| ⮴ +1![img.png](icons/TODO) and +1![img.png](icons/TODO)Increase your attack power by one, increase your defense power by one.                                                                                                                                                                                                                                                                              |
| 5![img.png](icons/TODO)1![img.png](icons/TODO)Increase your attack power by five, decrease your defense power by one. If you defense power becomes less than zero, set it to zero.                                                                                                                                                                                                                         |
| Double your ![img.png](icons/TODO)Increase your attack power by your attack power.                                                                                                                                                                                                                                                                                                                         |
| Add 2![img.png](icons/TODO) for every 5![img.png](icons/TODO)Increase your attack power by your wound count, divided by five, rounded down, times two.                                                                                                                                                                                                                                                     |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your attack power by your item count.                                                                                                                                                                                                                                                                                                       |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your attack power by your defense power.                                                                                                                                                                                                                                                                                                    |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your attack power by your speed value.                                                                                                                                                                                                                                                                                                      |
| ![img.png](icons/TODO) for every 2![img.png](icons/TODO)Increase your attack power by your monster count divided by two, rounded down.                                                                                                                                                                                                                                                                     |
| +1![img.png](icons/TODO) and +1![img.png](icons/TODO) at ![img.png](icons/TODO)3 or more                                                                                                                                                                                                                                                                                                                   |
| ⮴ 1![img.png](icons/TODO) and 1![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreIncrease your attack power and your defense power by one during a journey to slot three or higher.                                                                                                                                                                                                                 |
| +3![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreIncrease your attack power by three during a journey to slot three or higher.                                                                                                                                                                                                                                                                   |
| 3![img.png](icons/TODO) and 3![img.png](icons/TODO) against ![img.png](icons/TODO)Increase your attack power and your defense power by three when in combat with a dragon.                                                                                                                                                                                                                                 |
| +3![img.png](icons/TODO) and +3![img.png](icons/TODO) against ![img.png](icons/TODO)Increase your attack power and your defense power by three when in combat with a creature with slime icons.                                                                                                                                                                                                            |
| +1![img.png](icons/TODO) and +1![img.png](icons/TODO) when dueling other playersIncrease your attack power and your defense power by one when you are dueling with another player.                                                                                                                                                                                                                         |
| 4![img.png](icons/TODO) against ![img.png](icons/TODO)Increase your attack power by four when in combat with a card with undead icons.                                                                                                                                                                                                                                                                     |
| N![img.png](icons/TODO)Increase your defense power by N.                                                                                                                                                                                                                                                                                                                                                   |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your defense power by your attack power.                                                                                                                                                                                                                                                                                                    |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your defense power by your speed value.                                                                                                                                                                                                                                                                                                     |
| ![img.png](icons/TODO) for each ![img.png](icons/TODO)Increase your defense power by your enchantment count.                                                                                                                                                                                                                                                                                               |
| +3![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreIncrease your defense by three during a journey to slot three or higher.                                                                                                                                                                                                                                                                        |
| All players have +1![img.png](icons/TODO)Each player increases their speed value by one.                                                                                                                                                                                                                                                                                                                   |
| Ignore all ![img.png](icons/TODO)Your speed value is zero, regardless of your speed icon count.                                                                                                                                                                                                                                                                                                            |
| All players have +1![img.png](icons/TODO)Each player increases their weight value by one.                                                                                                                                                                                                                                                                                                                  |
| All players have +1 ![img.png](icons/TODO)Each player increases their pearl value by one.                                                                                                                                                                                                                                                                                                                  |
| Ignore all ![img.png](icons/TODO)Your pearl value is zero, regardless of your pearl icon count.                                                                                                                                                                                                                                                                                                            |
| Take N![img.png](icons/TODO)Take N crystals.                                                                                                                                                                                                                                                                                                                                                               |
| Take D6![img.png](icons/TODO)Roll a six-sided die, take crystals equal to the die value.                                                                                                                                                                                                                                                                                                                   |
| Take 1![img.png](icons/TODO) for every 2![img.png](icons/TODO) takenTake crystals equal to the amount of damage you took divided by two, rounded down.                                                                                                                                                                                                                                                     |
| Take 1![img.png](icons/TODO) for each 5![img.png](icons/TODO)Take crystals equal to your wound count divided by five, rounded down.                                                                                                                                                                                                                                                                        |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your attack value.                                                                                                                                                                                                                                                                                      |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your defense value.                                                                                                                                                                                                                                                                                     |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your weight value.                                                                                                                                                                                                                                                                                      |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your speed value.                                                                                                                                                                                                                                                                                       |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your slime value.                                                                                                                                                                                                                                                                                       |
| Take N![img.png](icons/TODO) for each ![img.png](icons/TODO)Take crystals equal to N multiplied by your monster count.                                                                                                                                                                                                                                                                                     |
| Steal N![img.png](icons/TODO) from a target                                                                                                                                                                                                                                                                                                                                                                |
| ⮴ Steal N![img.png](icons/TODO) from another playerTake N crystals from another player.                                                                                                                                                                                                                                                                                                                    |
| Take all ![img.png](icons/TODO) from the Overlord.Take all the crystals from the Overlord card.                                                                                                                                                                                                                                                                                                            |
| You cannot have more than 5![img.png](icons/TODO)Whenever you have more than five crystals, discard crystals until you have five. This also applies outside of your own turn.                                                                                                                                                                                                                              |
| Lose N![img.png](icons/TODO)Discard N of your crystals.                                                                                                                                                                                                                                                                                                                                                    |
| Lose all ![img.png](icons/TODO)Discard all your crystals.                                                                                                                                                                                                                                                                                                                                                  |
| Give N of your ![img.png](icons/TODO) to another playerGive N of your crystals to another player. If you have at least one crystal, but less than N crystals, give all of them to another player.                                                                                                                                                                                                          |
| Put 1 of your ![img.png](icons/TODO) on the OverlordPut one of your crystals on the Overlord card.                                                                                                                                                                                                                                                                                                         |
| Put 2![img.png](icons/TODO) from bank on the Overlord.Put two crystals from the supply on the Overlord card.                                                                                                                                                                                                                                                                                               |
| Pay 3![img.png](icons/TODO) or the Overlord attacksYou may discard three crystals. If you don’t, the Overlord attacks you.                                                                                                                                                                                                                                                                                 |
| Another player takes N![img.png](icons/TODO)Another player takes N crystals.                                                                                                                                                                                                                                                                                                                               |
| Other players take N![img.png](icons/TODO)Each other player takes N crystals.                                                                                                                                                                                                                                                                                                                              |
| Other players lose N![img.png](icons/TODO)Each other player discards N crystals.                                                                                                                                                                                                                                                                                                                           |
| Players start with 25![img.png](icons/TODO)Each player starts the game with twenty-five crystals instead of five.                                                                                                                                                                                                                                                                                          |
| All players put 2 of their ![img.png](icons/TODO) on the OverlordEach player puts two crystals on the Overlord card.                                                                                                                                                                                                                                                                                       |
| All players lose N![img.png](icons/TODO)Each player discards N crystals.                                                                                                                                                                                                                                                                                                                                   |
| You may give it to another playerYou may give this card to another player.                                                                                                                                                                                                                                                                                                                                 |
| Give to another playerGive this card to another player.                                                                                                                                                                                                                                                                                                                                                    |
| Bury this cardBury this card. You don’t add it to your stacks afterwards.                                                                                                                                                                                                                                                                                                                                  |
| Target player discards a card with ![img.png](icons/TODO)Another player discards one card with slime icons on it.                                                                                                                                                                                                                                                                                          |
| Other players must discard a card with ![img.png](icons/TODO)Each other player discards one card with speed icons on it.                                                                                                                                                                                                                                                                                   |
| Discard 2 cards with ![img.png](icons/TODO)Discard two cards with slime icons on it.                                                                                                                                                                                                                                                                                                                       |
| You cannot take another ![img.png](icons/TODO)You cannot journey to item cards. Whenever you would have to add a card to your item stack, discard it instead.                                                                                                                                                                                                                                              |
| You cannot use abilities on top ![img.png](icons/TODO)You cannot activate minor actions on your top item card.                                                                                                                                                                                                                                                                                             |
| This ![img.png](icons/TODO)  is the exact copy of your top ![img.png](icons/TODO)Treat this card as if it was a copy of your top enchantment card with the lower part of this card appended to the lower part of the enchantment card. It’s still an item card, and not an enchantment card.                                                                                                               |
| Steal top ![img.png](icons/TODO) from another playerTake the top item card of another player with at least two item cards.                                                                                                                                                                                                                                                                                 |
| Give your top ![img.png](icons/TODO) or ![img.png](icons/TODO) to another playerGive either your top item or your top enchantment to another player. You cannot give your top item if you have less than two items. You cannot give your top enchantment if you have less than two enchantments.                                                                                                           |
| Bury top ![img.png](icons/TODO) Bury your top item card.                                                                                                                                                                                                                                                                                                                                                   |
| Bury top ![img.png](icons/TODO) and ![img.png](icons/TODO)Bury your top item card and your top enchantment card, in any order.                                                                                                                                                                                                                                                                             |
| Unbury bottom ![img.png](icons/TODO)Unbury your bottom item card.                                                                                                                                                                                                                                                                                                                                          |
| Unbury bottom ![img.png](icons/TODO) and ![img.png](icons/TODO)Unbury your bottom item card and your bottom enchantment card, in any order.                                                                                                                                                                                                                                                                |
| Unbury bottom ![img.png](icons/TODO) or ![img.png](icons/TODO)Unbury either your bottom item card or your bottom enchantment card.                                                                                                                                                                                                                                                                         |
| Target player buries top ![img.png](icons/TODO)Another player with at least two item cards buries his top item card.                                                                                                                                                                                                                                                                                       |
| Target player unburies bottom ![img.png](icons/TODO)Another player with at least two item cards unburies his bottom item card.                                                                                                                                                                                                                                                                             |
| You may bury top ![img.png](icons/TODO) and/or ![img.png](icons/TODO)You may bury your top item card, and you may bury your top enchantment card, in any order.                                                                                                                                                                                                                                            |
| Discard top ![img.png](icons/TODO), ![img.png](icons/TODO) or ![img.png](icons/TODO)Discard either your top item card, your top enchantment card, or your top creature card. You cannot discard your top creature card if it’s a dragon.                                                                                                                                                                   |
| All players give top ![img.png](icons/TODO) and ![img.png](icons/TODO) to the player on their leftEach player gives their top item card and top enchantment card to the player to their left. This happens simultaneously and instantly. This also happens if you only have one item card or one enchantment card.                                                                                         |
| All players discard top ![img.png](icons/TODO), ![img.png](icons/TODO) or ![img.png](icons/TODO)Each player discards either their top item card, their top enchantment card, or their top creature card. You cannot discard your top creature card if it’s a dragon.                                                                                                                                       |
| All players discard ![img.png](icons/TODO)Each player with at least two item cards discards any one item card.                                                                                                                                                                                                                                                                                             |
| Other players may bury or unbury any of their ![img.png](icons/TODO) or ![img.png](icons/TODO)Each other player may bury their top item card or unbury their bottom item card. Each other player may bury their top enchantment card or unbury their bottom enchantment card. They may do these effects in any order.                                                                                      |
| All players unbury bottom ![img.png](icons/TODO) and ![img.png](icons/TODO)Each player unburies their bottom item card and their bottom enchantment card, in any order.                                                                                                                                                                                                                                    |
| You cannot use abilities on top ![img.png](icons/TODO)You cannot activate abilities on your top enchantment card.                                                                                                                                                                                                                                                                                          |
| Journey for any ![img.png](icons/TODO) on the OverlordYou may journey to any enchantment card on the Overlord card. Resolve 5.7 Journey results.                                                                                                                                                                                                                                                           |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
| You cannot take another ![img.png](icons/TODO)You cannot journey to enchantment cards. Whenever you would have to add a card to your enchantment stack, discard it instead.                                                                                                                                                                                                                                |
| Swap top ![img.png](icons/TODO) with another player’s top ![img.png](icons/TODO)Give your top enchantment card to another player. That player gives you his top enchantment card. This happens instantly and simultaneously, so it also happens if either or both players have only one enchantment card.                                                                                                  |
| Swap top ![img.png](icons/TODO) with an ![img.png](icons/TODO) from the journey trackSwap your top enchantment card with an enchantment card on the journey track. This is not a journey, so the immediate effects on the journey track card do not trigger.                                                                                                                                               |
| Steal top ![img.png](icons/TODO) from another playerTake the top enchantment card of another player with at least two enchantment cards.                                                                                                                                                                                                                                                                   |
| Put top ![img.png](icons/TODO) on the Overlord or lose 2![img.png](icons/TODO)You may put your top enchantment on the Overlord card. If you don’t, discard two crystals.                                                                                                                                                                                                                                   |
| Put invading ![img.png](icons/TODO) on the OverlordTake the enchantment card from the graveyard and put it on the Overlord card.                                                                                                                                                                                                                                                                           |
| Discard all your ![img.png](icons/TODO)If you have an of Enchanting card or a class card, select that one. Otherwise, select another enchantment card. Discard all other enchantment cards.                                                                                                                                                                                                                |
| Target player discards top ![img.png](icons/TODO)Another player discards their top enchantment. You cannot choose players with less than two enchantments.                                                                                                                                                                                                                                                 |
| Target player unburies bottom ![img.png](icons/TODO)Another player with at least two enchantment cards unburies his bottom enchantment card.                                                                                                                                                                                                                                                               |
| Unbury bottom ![img.png](icons/TODO)Unbury your bottom enchantment card.                                                                                                                                                                                                                                                                                                                                   |
| Target player unburies bottom ![img.png](icons/TODO)Another player with at least two enchantment cards unburies his bottom enchantment card.                                                                                                                                                                                                                                                               |
| Discard N![img.png](icons/TODO)Discard N of your monster cards.                                                                                                                                                                                                                                                                                                                                            |
| You may give 1![img.png](icons/TODO) to another playerYou may give one of your monster cards to another player.                                                                                                                                                                                                                                                                                            |
| Give your top ![img.png](icons/TODO) to another playerIf your top creature card is a monster, give it to another player.                                                                                                                                                                                                                                                                                   |
| Target player must give you ![img.png](icons/TODO)Another player gives you one of his monster cards.                                                                                                                                                                                                                                                                                                       |
| Target player discards ![img.png](icons/TODO)Another player discards one monster card.                                                                                                                                                                                                                                                                                                                     |
| Other players must give you 1![img.png](icons/TODO)Each other player gives you one monster card.                                                                                                                                                                                                                                                                                                           |
| Other players discard ![img.png](icons/TODO)Each other player discards one monster card.                                                                                                                                                                                                                                                                                                                   |
| All players discard ![img.png](icons/TODO)Each player discards one of their monster cards.                                                                                                                                                                                                                                                                                                                 |
| Banner and Class card abilities don’t workBanner and class cards act as if there is no ability text on them. Their icons are still effective though.                                                                                                                                                                                                                                                       |
| Journeys to ![img.png](icons/TODO)3 or more cost you only 2![img.png](icons/TODO)The base cost to travel to slots number three or higher is changed to two crystals.                                                                                                                                                                                                                                       |
| Your journey is free this turnThe final cost to travel to any slot is zero crystals until the end of your turn.                                                                                                                                                                                                                                                                                            |
| Swap 2 cards on the Journey TrackSwap two cards on the journey track.                                                                                                                                                                                                                                                                                                                                      |
| Player on your left attacks youThe player to your left attacks you.                                                                                                                                                                                                                                                                                                                                        |
| All players attack a player on their leftEach player attacks the player to their left.                                                                                                                                                                                                                                                                                                                     |
| Each player attacks the player to their rightEach player attacks the player to their right.                                                                                                                                                                                                                                                                                                                |
| You may duel a target playerYou may duel another player.                                                                                                                                                                                                                                                                                                                                                   |
| You may duel the player on your leftYou may duel the player on your left.                                                                                                                                                                                                                                                                                                                                  |
| You may duel the player on your rightYou may duel the player on your right.                                                                                                                                                                                                                                                                                                                                |
| All players duel the player on their leftEach player duels the player to their left.                                                                                                                                                                                                                                                                                                                       |
| In co-op mode, each player duels the Overlord.                                                                                                                                                                                                                                                                                                                                                             |
| (If there is 1![img.png](icons/TODO) per player on the ![img.png](icons/TODO)) replace it, then current player takes 5![img.png](icons/TODO)Remove the award tokens from the village, then remove the village card itself from the game, then replace it by another village card, using the same selection techniques as used during setup. Then the current player takes five damage.                     |
| Add 1![img.png](icons/TODO) to on the ![img.png](icons/TODO)Put a reward token from the supply on the village card.                                                                                                                                                                                                                                                                                        |
| Add 1![img.png](icons/TODO) to on the ![img.png](icons/TODO) and 1![img.png](icons/TODO) on the OverlordPut a reward token from the supply on the village card, and another one from the supply on the Overlord card.                                                                                                                                                                                      |
| Remove 1![img.png](icons/TODO) from the ![img.png](icons/TODO)Take one reward token from the village card, if any, and discard it.                                                                                                                                                                                                                                                                         |
| Journey for any card on the OverlordYou may journey to any card on the Overlord card. Resolve 5.7 Journey results.                                                                                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
| After a journey on ![img.png](icons/TODO)0 the player takes 3![img.png](icons/TODO)Whenever a player journeys to track slot zero, he takes three damage.                                                                                                                                                                                                                                                   |
| Discard all ![img.png](icons/TODO) from Journey Track cardsDiscard all the wound tokens on journey track cards.                                                                                                                                                                                                                                                                                            |
| Journey to the graveyard                                                                                                                                                                                                                                                                                                                                                                                   |
| ⮴ Journey to the graveyard, don’t end your turnYou may journey to the graveyard.                                                                                                                                                                                                                                                                                                                           |
...
| Place the bottom N cards from the graveyard on the OverlordTake the bottom N cards on the graveyard and put them on the Overlord card in any order.                                                                                                                                                                                                                                                        |
| Deals double damageIf this creature deals damage when attacking, double the amount of damage it deals.                                                                                                                                                                                                                                                                                                     |
| Attacks all playersWhenever this creature would attack one player, it attacks each player instead.                                                                                                                                                                                                                                                                                                         |
| All ![img.png](icons/TODO) and ![img.png](icons/TODO) get +2![img.png](icons/TODO)When determining the stats of a monster or dragon, increase health by two.                                                                                                                                                                                                                                               |
| All ![img.png](icons/TODO) and ![img.png](icons/TODO) get +1![img.png](icons/TODO) and +1![img.png](icons/TODO) on ![img.png](icons/TODO)2 or lessWhen determining the stats of a monster or dragon, if it’s in slot number two or lower, increase health and strength by one.                                                                                                                             |
| All ![img.png](icons/TODO) and ![img.png](icons/TODO) get +1![img.png](icons/TODO) and +1![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreWhen determining the stats of a monster or dragon, if it’s in a slot number three or higher, increase health and strength by one.                                                                                                                        |
| All ![img.png](icons/TODO) get +1![img.png](icons/TODO) and +1![img.png](icons/TODO)When determining the stats of a dragon, increase health and strength by one.                                                                                                                                                                                                                                           |
| +1![img.png](icons/TODO) and ![img.png](icons/TODO) for every 5![img.png](icons/TODO)When determining the stats of this creature, increase health and strength by a number equal to your wound count divided by five, rounded down.                                                                                                                                                                        |
| +1![img.png](icons/TODO) and ![img.png](icons/TODO) for each ![img.png](icons/TODO)When determining the stats of this creature, increase health and strength by a number equal to your undead value.                                                                                                                                                                                                       |
| +1![img.png](icons/TODO) and ![img.png](icons/TODO) for each ![img.png](icons/TODO)When determining the stats of this creature, increase health and strength by a number equal to your slime value.                                                                                                                                                                                                        |
| +1![img.png](icons/TODO) for each ![img.png](icons/TODO)When determining the stats of this creature, increase health by a number equal to your slime value.                                                                                                                                                                                                                                                |
| +4![img.png](icons/TODO) on ![img.png](icons/TODO)2 or lessWhen determining the stats of this creature, increase health by four if the card is in journey track slot two or lower.                                                                                                                                                                                                                         |
| +3![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreWhen determining the stats of this creature, increase health by three if the card is in journey track slot three or higher.                                                                                                                                                                                                                     |
| +1![img.png](icons/TODO) for each ![img.png](icons/TODO)When determining the stats of this creature, increase strength by a number equal to your slime value.                                                                                                                                                                                                                                              |
| +6![img.png](icons/TODO) on ![img.png](icons/TODO)2 or lessWhen determining the stats of this creature, increase strength by five if the card is in journey track slot two or lower.                                                                                                                                                                                                                       |
| +3![img.png](icons/TODO) on ![img.png](icons/TODO)3 or moreWhen determining the stats of this creature, increase strength by three if the card is in journey track slot three or higher.                                                                                                                                                                                                                   |
| Trigger ![img.png](icons/TODO) invasionResolve all abilities of the Overlord that would be triggered by a dragon invasion.                                                                                                                                                                                                                                                                                 |
| Fight the OverlordSee: 5.11 Challenging the Overlord.                                                                                                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                            |
| You cannot fight ![img.png](icons/TODO)You cannot challenge the Overlord.                                                                                                                                                                                                                                                                                                                                  |
| ![img.png](icons/TODO) is immune to damageWhenever an effect would lower the hit points of the Overlord, it does nothing instead.                                                                                                                                                                                                                                                                          |
| Add ![img.png](icons/TODO) on Overlord                                                                                                                                                                                                                                                                                                                                                                     |
| ⮴ Add ![img.png](icons/TODO) on the Overlord                                                                                                                                                                                                                                                                                                                                                               |
| ⮴ Add ![img.png](icons/TODO) to the OverlordPut a reward token from the supply on the Overlord card.                                                                                                                                                                                                                                                                                                       |
| Add 1![img.png](icons/TODO) per player on the Overlord                                                                                                                                                                                                                                                                                                                                                     |
| ⮴ Add 1![img.png](icons/TODO) for each player to the OverlordPut a number of reward tokens from the supply on the Overlord card equal to the number of players.                                                                                                                                                                                                                                            |
| Remove 1![img.png](icons/TODO) from the OverlordDiscard one reward token from the Overlord card.                                                                                                                                                                                                                                                                                                           |
| The overlord has +2![img.png](icons/TODO) and +2![img.png](icons/TODO) for each ![img.png](icons/TODO) you haveWhen determining the stats of the Overlord during your turn, increase health and strength by the number of dragons you have, times two.                                                                                                                                                     |
| The overlord has +1![img.png](icons/TODO) and +1![img.png](icons/TODO) for each ![img.png](icons/TODO) you haveWhen determining the stats of the Overlord during your turn, increase health and strength by the amount of reward tokens you have.                                                                                                                                                          |
| The Overlord attacks current playerThe Overlord attacks you.                                                                                                                                                                                                                                                                                                                                               |
| The Overlord attacks all playersThe Overlord attacks each player, starting with the active player or the starting player, clockwise.                                                                                                                                                                                                                                                                       |
| Overlord attacks the player with the lowest ![img.png](icons/TODO)The Overlord attacks one of the players with the lowest defense power. If there are multiple targets, choose one as a group.                                                                                                                                                                                                             |
| Overlord attacks the player with the highest ![img.png](icons/TODO)The Overlord attacks one of the players with the highest defense power. If there are multiple targets, choose one as a group.                                                                                                                                                                                                           |
| ![img.png](icons/TODO) takes ![img.png](icons/TODO) equal to the ![img.png](icons/TODO) of removed cardThe Overlord takes damage equal to the victory points the removed card was worth after removing it from its stack.                                                                                                                                                                                  |
| If the removed card was a dragon card with a negative effect in its lower part, add a reinforcement token on the Overlord, random side up.                                                                                                                                                                                                                                                                 |
| Overlord removes all ![img.png](icons/TODO) then takes 2![img.png](icons/TODO) and 1 Reinforcement token for each ![img.png](icons/TODO) removedDiscard all reward tokens on cards on the journey track. The Overlord takes damage equal to two times the number of tokens discarded. Put a number of reinforcement tokens from the supply on the Overlord equal to the number of reward tokens discarded. |
| Put the Cerberus token on a card at ![img.png](icons/TODO)0If there is a card in journey track slot zero, put the Cerberus token on it.                                                                                                                                                                                                                                                                    |
| If Cerberus token is on ![img.png](icons/TODO) or ![img.png](icons/TODO) players take 3![img.png](icons/TODO), otherwise ![img.png](icons/TODO) heals 3![img.png](icons/TODO)If the Cerberus token is on a creature card, each player takes three damage, otherwise the Overlord heals three damage.                                                                                                       |
| Shuffle AI DeckShuffle the Overlord event deck.                                                                                                                                                                                                                                                                                                                                                            |
| Flip the Desert TokenFlip the desert token.                                                                                                                                                                                                                                                                                                                                                                |
| You may flip the Desert TokenYou may flip the desert token.                                                                                                                                                                                                                                                                                                                                                |
| Double the effect of the Desert TokenDouble the effect of the desert token.                                                                                                                                                                                                                                                                                                                                |
...
| You may ignore the effect of the Desert Token on your turnThis acts as a minor action with no cost that says “Ignore the effect of the Desert Token until the end of your turn”. This action can only be activated during your turn.                                                                                                                                                                       |
| Turn the Desert Token to its Sandstorm side.If the “+one![img.png](icons/TODO) -one![img.png](icons/TODO)” side of the desert token is face up, flip it.                                                                                                                                                                                                                                                   |
| Turn the Desert Token to its Sandstorm side.If the “+one ![img.png](icons/TODO) -one ![img.png](icons/TODO)” side of the desert token is face up, flip it.                                                                                                                                                                                                                                                 |
| All players lose                                                                                                                                                                                                                                                                                                                                                                                           |
| ⮴ You loseEach player loses the game.                                                                                                                                                                                                                                                                                                                                                                      |
